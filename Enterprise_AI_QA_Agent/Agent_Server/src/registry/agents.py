        ...
        self._agents: dict[str, AgentModule] = {
            "coordinator": AgentModule(
                descriptor=AgentDescriptor(
                    ...
                    supported_skills=["requirements-analysis", "risk-scoping", "report-synthesis", "agently-mail", "mail-capability"],
            ...
            "ops-executor": AgentModule(
                descriptor=AgentDescriptor(
                    ...
                    supported_skills=["artifact-collection", "report-synthesis", "agently-mail", "mail-capability"],
