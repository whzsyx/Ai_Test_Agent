"""AWS Agent Mailbox Agent Mailbox adapter."""
...
class AwsAgentMailboxAdapter(RestMailAdapterBase):
    """AWS Agent Mailbox provider - REST API adapter."""

    provider_key = "aws_agent_mailbox"
    default_base_url = "https://agent-mailbox.amazonaws.com/v1"
